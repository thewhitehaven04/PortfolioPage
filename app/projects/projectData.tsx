...
export const projects: ComponentProps<typeof ProjectCard>[] = [
    {
        ...
        images: [
            { ...f1StatsImg0, id: "f1stats-img8", alt: "F1Stats screenshot 1", height: 720, width: 1280 },
            { ...f1StatsImg1, id: "f1stats-img1", alt: "F1Stats screenshot 2", height: 720, width: 1280 },
            { ...f1StatsImg2, id: "f1stats-img2", alt: "F1Stats screenshot 3", height: 720, width: 1280 },
            { ...f1StatsImg3, id: "f1stats-img3", alt: "F1Stats screenshot 4", height: 720, width: 1280 },
            { ...f1StatsImg4, id: "f1stats-img4", alt: "F1Stats screenshot 5", height: 720, width: 1280 },
            { ...f1StatsImg5, id: "f1stats-img5", alt: "F1Stats screenshot 6", height: 720, width: 1280 },
            { ...f1StatsImg6, id: "f1stats-img6", alt: "F1Stats screenshot 7", height: 720, width: 1280 },
            { ...f1StatsImg7, id: "f1stats-img7", alt: "F1Stats screenshot 8", height: 720, width: 1280 },
        ],
        stack: (
            <>
